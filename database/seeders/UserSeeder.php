...
class UserSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('users')->insert([
            ...
            'rights' => '["print_list","view_users_hosts_and_vendors_list","view_details_about_hosts_and_vendors","resend_otp","view_list_of_staff_members","view_details_of_each_staff_member","edit_staff_members","edit_self_staff_account_information","add_new_staff_member","view_events_list","view_event_details","edit_event_details","view_event_type_list","add_new_event_type","edit_event_type","delete_event_type","view_event_subcategories_list","view_event_subcategory_details","edit_event_subcategory","delete_event_subcategory","view_reviews_list","view_review_details","review_edit","view_categories_list","edit_category","delete_category_add_new_category","view_companies_list","view_company_details","edit_company_details","view_taxes_list","view_taxe_details","edit_taxe","delete_taxe","view_vendors_classes_list","view_vendor_class_details","view_payments_list","view_payment_details","view_subscription_list","view_subscription_details","add_new_subscription","edit_subscription","delete_subscritpion","view_contents_texts_list","view_content_text","edit_content_text","view_contents_images_list","view_content_image","edit_content_image","view_limits_list","edit_limit"]'
        ]);
        ...
        DB::table('users')->insert([
            ...
            'otp' => '879809',
            'created_at' => Carbon::now(),
            'rights' => '["view_events_list","view_event_details","edit_event_details","view_event_type_list","add_new_event_type","edit_event_type","delete_event_type","view_event_subcategories_list","view_event_subcategory_details","edit_event_subcategory","delete_event_subcategory","view_reviews_list","view_review_details","review_edit","view_categories_list","edit_category","delete_category_add_new_category","view_companies_list","view_company_details","edit_company_details","view_taxes_list","view_taxe_details","edit_taxe","delete_taxe","view_vendors_classes_list","view_vendor_class_details","view_payments_list","view_payment_details","view_subscription_list","view_subscription_details","add_new_subscription","edit_subscription","delete_subscritpion","view_contents_texts_list","view_content_text","edit_content_text","view_contents_images_list","view_content_image","edit_content_image","view_limits_list","edit_limit"]'
        ]);
    }
}
