...
<div class="card card-primary">
      ...
      <h3 class="card-title">User's  Details</h3>
        <div class="card-tools">
            <div style="position: relative; display: inline-block;">
                ...
                @else
                    <img src="{{ asset('storage/'. $userFound->profile_image) }}" alt="Product 1" class="img-circle img-size-32 mr-2" style="border: none">
                @endif
    ...
    <tr>
        <th>Gender</th>
        <td>{{ $userFound->user_genders_id ?? "Not set yet"}}</td>
    </tr>    
    <tr>
        <th>Occupation</th>
    ...
    <tr>
        <th>Age</th>
        <td>{{ $userFound->age ?? "Not set yet"}}</td>
    </tr>
    <tr>
        <th>Credit</th>
