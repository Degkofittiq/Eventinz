                    ...
                    @foreach($rightTypes as $rightType)
                        ...
                        <ul>
                            @foreach($rightType->rights as $right)
                                <input type="checkbox" name="rights[]" id="rights[]" value="{{ $right->name }}" class=" @error('rights') is-invallid @enderror" placeholder="Put the new Admin/Master Rights"> <!-- Right Name -->
